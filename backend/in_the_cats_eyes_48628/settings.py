"""
Django settings for in_the_cats_eyes_48628 project.
...
ROOT_URLCONF = 'in_the_cats_eyes_48628.urls'
...
WSGI_APPLICATION = 'in_the_cats_eyes_48628.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "In the Cats Eyes Support <support@in-the-cats-eyes-48628.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "in_the_cats_eyes_48628 API",
    "DESCRIPTION": "API documentation for in_the_cats_eyes_48628 App",
    "VERSION": "v1",
}
